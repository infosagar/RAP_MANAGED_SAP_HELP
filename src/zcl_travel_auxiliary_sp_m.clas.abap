CLASS zcl_travel_auxiliary_sp_m DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*   Type definition for import parameters --------------------------
    ...
    TYPES tt_travel_reported            TYPE TABLE FOR REPORTED zi_travel_sp_m.
    TYPES tt_booking_reported           TYPE TABLE FOR REPORTED  zi_booking_sp_m.
    TYPES tt_bookingsupplement_reported TYPE TABLE FOR REPORTED  zi_booksuppl_sp_m.
...
CLASS zcl_travel_auxiliary_sp_m IMPLEMENTATION.
...
*  (1) Read relevant travel instance data -------------------------------------------------
    READ ENTITIES OF zi_travel_sp_m
         ENTITY travel
...
*  (4) Update the total_price value for the relevant travel instance  -------------------------------------------------
    MODIFY ENTITIES OF zi_travel_sp_m
          ENTITY travel
