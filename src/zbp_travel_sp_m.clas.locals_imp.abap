...
**********************************************************************
  METHOD validate_travel_status.
   ...
   READ ENTITY zI_Travel_sp_M\\travel FIELDS ( overall_status ) WITH
  ...
  METHOD copy_travel.
    ...
    DATA lt_create TYPE TABLE FOR CREATE ZI_Travel_SP_M\\travel.
    ...
    MODIFY ENTITIES OF Zi_travel_SP_m IN LOCAL MODE
        ENTITY travel
