@AbapCatalog.sqlViewName: 'ZIBOOKING_SP_M'
...
define view ZI_Booking_SP_M
  as select from /dmo/booking_m as Booking

  association        to parent ZI_Travel_SP_M as _Travel     on  $projection.travel_id = _Travel.travel_id
  composition [0..*] of ZI_BookSuppl_SP_M     as _BookSupplement
