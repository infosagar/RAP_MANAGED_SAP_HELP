@EndUserText.label: 'Travel projection view for approver'
...
define root view entity ZC_TRAVEL_APPROVER_SP_M
  as projection on ZI_Travel_SP_M
{
  ...
  key travel_id          as TravelID,
      ...
      /* Associations */
      _Booking : redirected to composition child ZC_Booking_Approver_SP_M,
      _Agency,
      _Customer
}
